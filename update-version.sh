...
yarn workspace @datadog/mobile-react-native-profiling pack
...
./check-release-content.sh -p packages/react-native-profiling/package.tgz > packages/react-native-profiling/release-content.txt
