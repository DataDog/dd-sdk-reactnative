...
describe('DdSdkReactNativeConfiguration', () => {
    describe('buildConfigurationFromPartialConfiguration', () => {
                ...
                buildConfigurationFromPartialConfiguration(
                    {
                        ...
                        resourceTracingSamplingRate: 80,
        ...
        it('builds the SDK configuration with flags configuration enabled', () => {
            expect(
                buildConfigurationFromPartialConfiguration(
                    {
                        trackErrors: false,
        ...
        it('builds the SDK configuration with flags configuration disabled', () => {
            expect(
                buildConfigurationFromPartialConfiguration(
                    {
                        trackErrors: false,
        ...
        it('builds the SDK configuration with full flags configuration', () => {
            expect(
                buildConfigurationFromPartialConfiguration(
                    {
                        trackErrors: true,
