...
Pod::Spec.new do |s|
  ...
  s.dependency 'DatadogCore', '3.3.0'
  s.dependency 'DatadogLogs', '3.3.0'
  s.dependency 'DatadogTrace', '3.3.0'
  s.dependency 'DatadogRUM', '3.3.0'
  s.dependency 'DatadogCrashReporting', '3.3.0'

  # DatadogWebViewTracking is not available for tvOS
  s.ios.dependency 'DatadogWebViewTracking', '3.3.0'
