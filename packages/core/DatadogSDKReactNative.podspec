...
Pod::Spec.new do |s|
  ...
  s.dependency 'DatadogCore', '~> 2.23.0'
  s.dependency 'DatadogLogs', '~> 2.23.0'
  s.dependency 'DatadogTrace', '~> 2.23.0'
  s.dependency 'DatadogRUM', '~> 2.23.0'
  s.dependency 'DatadogCrashReporting', '~> 2.23.0'

  # DatadogWebViewTracking is not available for tvOS
  s.ios.dependency 'DatadogWebViewTracking', '~> 2.23.0'
