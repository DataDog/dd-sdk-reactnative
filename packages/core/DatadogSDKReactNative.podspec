...
Pod::Spec.new do |s|
  ...
  s.dependency 'DatadogLogs', '3.10.0'
  s.dependency 'DatadogTrace', '3.10.0'
  s.dependency 'DatadogRUM', '3.10.0'
  s.dependency 'DatadogCrashReporting', '3.10.0'
  s.dependency 'DatadogFlags', '3.10.0'

  # DatadogWebViewTracking is not available for tvOS
  s.ios.dependency 'DatadogWebViewTracking', '3.10.0'
